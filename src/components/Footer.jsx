        ...
        <div className="row ">
          ...
          <div className="col-md-5 mb-4">
            ...
            <ul className="list-unstyled mt-3">
              <li className="mb-2 d-flex align-items-center footer-link gap-2">
                <FaMapMarkerAlt /> Plot No. 01 Naruka Colony Basant Vihar Sikar
                (Raj.) 332001
              </li>
              <a
                href="tel:9602515835"
          ...
          <div className="col-md-3 mb-4">
            ...
            <ul className="list-unstyled">
              ...
              <li className="mb-2">
                <Link to="/carrer" className="footer-link">
                  Careers
                </Link>
              </li>
              <li className="mb-2">
          ...
          <div className="col-md-4 mb-4">
            ...
            <ul className="list-unstyled d-flex gap-3">
              <li>
                <a
                  href="https://www.facebook.com/share/17B3yHfwwZ"
                  className="social"
                >
                  <FaFacebookF size={20} />
                </a>
              ...
              <li>
                <a
                  href="https://youtube.com/@kidneyhealthgyan?si=G3stRY7BFhPmOXDy"
                  className="social"
                >
                  <FaYoutube size={20} />
                </a>
              ...
              <li>
                <a
                  href="https://www.instagram.com/nephroredrenalcare/"
                  className="social"
                  target="_blank"
