...
import clinical from "../assets/clinical-protocols.png";
import partnership from "../assets/partnership.png";
import market from "../assets/market-expertise.png";
 ...
 const circleSlides = [
  ...
  return (
   ...
   <section className="setup-section py-5">
    ...
    {/* SECTION-8 : WHAT DO WE OFFER */}
<section className="offer-section py-5">
  <div className="container">

    <h2 className="text-center offer-heading mb-5" data-aos="fade-down">
      What Do We Offer?
    </h2>
    ...
    <div className="row g-4">
      <div className="col-lg-4 col-md-6" data-aos="zoom-in">
        <div className="offer-card h-100">
          <img src={clinical} alt="Clinical Protocols" className="offer-img" />
          <h4 className="offer-title">Best-in-Class Clinical Protocols</h4>
          <p className="offer-text">
            Dedicated central team with experience from top institutions Medanta,
            Fortis, Tata Memorial, Max ensuring protocol compliance.
            Real-time checks with periodic and surprises audits
          </p>
        </div>
      </div>
      ...
      <div className="col-lg-4 col-md-6" data-aos="zoom-in">
        <div className="offer-card h-100">
          <img src={partnership} alt="Win-Win Partnership" className="offer-img" />
          <h4 className="offer-title">Win-Win Partnership</h4>
          <p className="offer-text">
            Tailored commercial propositions for hospital, nephrologist and
            Nephrored Renal Care. Transparent paperwork, streamlined billing, and
            comprehensive reviews. Patient-focused partnership: Nephrored Renal Care
            manages all operations and challenges.
          </p>
        </div>
      </div>
      ...
      <div className="col-lg-4 col-md-6" data-aos="zoom-in">
        <div className="offer-card h-100">
          <img src={market} alt="Market Expertise" className="offer-img" />
          <h4 className="offer-title">Market Expertise</h4>
          <p className="offer-text">
            Deep understanding of marketing assessment and pricing strategies.
            Rapid ‘go to market’ and launch approach driving utilization proven
            track record in patient acquisition and retention
          </p>
        </div>
      </div>
    </div>
